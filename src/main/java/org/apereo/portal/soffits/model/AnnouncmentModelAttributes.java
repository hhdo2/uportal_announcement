 ...
 */
@Component
public class AnnouncementModelAttributes {
    ...
    @SoffitModelAttribute(value="preferencesJson",viewRegex=".*/announcement/.*")
    ...
    @SoffitModelAttribute(value="definitionJson",viewRegex=".*/announcement/.*")
